...
export interface CreatingEvent<Key extends string, Value> extends Event<typeof CreatingEventType> {
    key: Key
    value: Value
}

export const CreatedEventType = "@opennetwork/environment/storage/store/created"
export interface CreatedEvent<Key extends string, Value> extends Event<typeof CreatedEventType> {
    key: Key
    value: Value
}

export const UpdatingEventType = "@opennetwork/environment/storage/store/updating"
export interface UpdatingEvent<Key extends string, Value> extends Event<typeof UpdatingEventType> {
    key: Key
    previousValue: Value
    value: Value
}
...
export interface UpdatedEvent<Key extends string, Value> extends Event<typeof UpdatedEventType> {
    key: Key
    previousValue: Value
    value: Value
}
...
export interface DeletingEvent<Key extends string, Value> extends Event<typeof DeletingEventType> {
    key: Key
    previousValue: Value
}

export const DeletedEventType = "@opennetwork/environment/storage/store/deleted"
export interface DeletedEvent<Key extends string, Value> extends Event<typeof DeletedEventType> {
    key: Key
    previousValue: Value
}

export type StoreEvent<Key extends string, Value> =
...
export const StoreEvents: StoreEvent<string, unknown>["type"][] = [
    CreatingEventType,
    CreatedEventType,
    UpdatingEventType,
    UpdatedEventType,
...
export interface StoreEventTarget<Key extends string, Value> extends EventTarget {
