import { Response as AnyResponse, Request } from "https://cdn.skypack.dev/@opennetwork/http-representation";
...
export async function dispatchFetchEvent({ request: httpRequest, abortTimeout, signal: externalSignal, type }) {
