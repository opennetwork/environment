...
import { addFetchEventListener, addRenderFetchEventListener } from "./lib/index.js";
function notFound() {
...
addFetchEventListener({ method: "GET", pathname: "/ping" }, ({ respondWith }) => respondWith(new Response("Pong", {
    status: 200
})));
addFetchEventListener({ method: "GET", pathname: "/pong" }, ({ respondWith }) => respondWith(new Response("Ping", {
    status: 200
})));
addFetchEventListener({ method: "GET", pathname: "/hello" }, ({ respondWith }) => respondWith(new Response("World", {
    status: 200
})));
...
addFetchEventListener({ method: "GET", pathname: "/browser-script" }, ({ respondWith }) => respondWith(new Response(`
...
addFetchEventListener({ method: "GET", pathname: "/template-script" }, ({ respondWith }) => respondWith(new Response(`
...
addFetchEventListener({ pathname: /^\/\d{3}$/ }, ({ respondWith, url: { pathname } }) => respondWith(new Response("", {
...
addEventListener("external-fetch", async ({ request, respondWith }) => {
